...
/*#__PURE__*/
function () {
  function SimpleCarousel(slideNameSpace) {
  ...
  _createClass(SimpleCarousel, [{
    ...
    value: function initialize() {
      ...
      this.setSlidesSize();
      this.onResizeSlides();
      this.prevButtonElement.addEventListener('click', function () {
        _this.gotoSlide(_this.currentSlideIndex - 1);
      });
      this.nextButtonElement.addEventListener('click', function () {
        _this.gotoSlide(_this.currentSlideIndex + 1);
      });
      this.updateState();
    }
    ...
    value: function onResizeSlides() {
      ...
      window.addEventListener('resize', function () {
        ...
        var timer = setTimeout(function () {
          _this2.setSlidesSize();
        }, 200);
      });
    }
  }, {
    key: "setSlidesSize",
    value: function setSlidesSize() {
      var slides = document.querySelectorAll(this.slideNameSpace + '__wrapper__slides__inner > ul > li');
      var wrapContentWidth = this.targetSlidesElement.clientWidth;
      var wrapContentHeight = this.targetSlidesElement.clientHeight;
    ...
    value: function gotoSlide(targetIndex) {
      ...
      // 連打禁止
      if (!this.isMoved) {
        var nextSlideIndex = targetIndex % this.allSlideIndex;
        var toX = -100 * nextSlideIndex;
        this.updateState();
        this.isMoved = true;

        _gsap.TweenMax.to(this.targetSlidesElement, 0.4, {
          x: toX + '%',
          onComplete: function onComplete() {
            _this3.isMoved = false;
    ...
    value: function updateState() {
      ...
      for (var i = 0; i < this.dotsButtons.length; i++) {
        var dotElement = this.dotsButtons[i];
    ...
    value: function insertDots() {
      ...
      var _loop = function _loop(i) {
        var labelNumber = i !== 0 ? i + 1 : 1;
        var newDot = document.createElement('button');
        var dotlabel = document.createTextNode(labelNumber);
        newDot.appendChild(dotlabel);
        newDot.setAttribute('data-index', i);
        newDot.addEventListener('click', function () {
          return _this4.onClickDots(newDot);
        });

        _this4.targetDotsElement.appendChild(newDot);
      };

      for (var i = 0; i < this.allSlideIndex; i++) {
        _loop(i);
      }
    ...
    key: "onClickDots",
    value: function onClickDots(newDot) {
      var targetNum = newDot.getAttribute('data-index');
...
},{"gsap":1}],3:[function(require,module,exports){
"use strict";

var _SimpleCarousel = _interopRequireDefault(require("./SimpleCarousel"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

new _SimpleCarousel.default('.carousel');
